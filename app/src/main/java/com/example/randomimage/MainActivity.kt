...
class MainActivity : AppCompatActivity() {
    ...
    private fun isiGambar(txtHello: TextView, image1: ImageView){
        ...
        when (tes) {
            1 -> image1.setImageDrawable(getDrawable(R.drawable.batman1))
            2 -> image1.setImageDrawable(getDrawable(R.drawable.batman2))
            3 -> image1.setImageDrawable(getDrawable(R.drawable.batman3))
            4 -> image1.setImageDrawable(getDrawable(R.drawable.batman4))
            5 -> image1.setImageDrawable(getDrawable(R.drawable.batman5))
            else -> { // Note the block
                image1.setImageDrawable(getDrawable(R.drawable.batman6))
            }
        }
    }
